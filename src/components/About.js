      ...
      <div className="about-container">
        ...
        <div className="about-content">
          <div className="about-text">
            ...
            <p>When I'm not crafting code, I'm an explorer at heart. You might catch me cruising on my skateboard, diving into a good book, or jamming to music that resonates with the rhythm of creativity.</p>
